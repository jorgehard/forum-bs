         ...
         <div class="col-sm-9 blog-main">
          ...
          <div class="blog-post">
			<?php
				...
				$sql = mysqli_query($con, "SELECT * FROM videos ORDER by data DESC LIMIT $inicio, $quantidade");
			...
			<div class="embed-responsive embed-responsive-16by9">
				<iframe class="embed-responsive-item" src="//www.youtube.com/embed/<?php echo $res['link'];?>" frameborder="0" allowfullscreen></iframe>
			</div><br/>
			<?php }} ?>
