        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">        
            ...
            <aside class="right-side">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home </a></li><li>
                    </ol>
                </section>
				...
				<section class="connectedSortable">    
						<?php
							...
							$conl = mysqli_query($con, "SELECT * FROM contato where id = '$id'");
							$contando = mysqli_num_rows($conl);
							if($contando <= 0) {
								echo '<h2>Nada encontrado...</h2>';
							} else {
								while($msgcont = mysqli_fetch_array($conl)) {
						?>
							<div class="box box-primary">
                                <div class="box-header">
                                    <i class="ion ion-clipboard"></i>
                                    <h3 class="box-title"><?php echo $msgcont['assunto'];?></h3>
									 <div class="box-tools pull-right">
                                        <h4>
                                                <a href="ex-cont.php?id=<?php echo $msgcont['id'];?>"><i class="fa fa-trash-o"></i></a>
                                        </h4>
                                    </div>
                                </div>
                                <div class="box-body">
								<div style="opacity:0.6"><i class="fa fa-user"></i> <span><?php echo $msgcont['nome'];?></span></div><br/>
								<div style="opacity:0.6"><i class="fa fa-envelope"></i> <span><?php echo $msgcont['email'];?></span></div><br/>
                                    <ul class="todo-list">
                                        <li>
                                            <span class="text"><?php echo $msgcont['assunto'];?></span>
                                            <span class="label label-danger" style="font-size:12px; float:right;"><i class="fa fa-clock-o"></i> <?php echo date('d', strtotime($msgcont['data'])). " de " .$mes[date('m', strtotime($msgcont['data']))]. " de ". date('Y', strtotime($msgcont['data']))." as ".date('H', strtotime($msgcont['data'])). ":" .date('s', strtotime($msgcont['data']))."h"; ?></span>
											<hr/>
											<span><?php echo $msgcont['texto'];?></span>
									   </li>
                                    </ul>
                                </div>
