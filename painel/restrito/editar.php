        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
				...
				<section id="tudonoticia">
					<?php 
						$sql = "SELECT titulo, id, imagem, resumo FROM news ORDER BY data DESC";
						$query = mysqli_query($con, $sql);
						if(!$query) {
							echo mysqli_error($con); 
						} else {
							while($res = mysqli_fetch_assoc($query)) {
								echo "<div class='itemnot'>"; 
								?>
								<a class="img-thumbnail" href="editarnot.php?id=<?php echo $res['id']; ?>">
								<img alt="" src="imagens/<?php echo $res['imagem']; ?>" class="" width="200px" height="150px"/> 
								<h5>	
